...
tpg = tephi.Tephigram()
profile = tpg.plot(dews, label='Dew-point temperature', linewidth=2, linestyle='--', marker='s')
...
profile.barbs(barbs, edgecolor="red", facecolor='black', sizes={"spacing": 0.2}, lw=2, path_effects=[pe.Stroke()])
